...
# Personalizzazione italiana delle etichette del percorso "en".
_REPORT_LABELS["en"].update({
    "dashboard_title": "Quadro decisionale",
    "brief_title": "Sintesi operativa",
    ...
    "watch_label": "Osserva",
    "sell_label": "Vendi",
    "summary_heading": "Riepilogo delle analisi",
    "info_heading": "Informazioni principali",
    "sentiment_summary_label": "Sentiment",
    "earnings_outlook_label": "Prospettive degli utili",
    "risk_alerts_label": "Segnalazioni di rischio",
    "positive_catalysts_label": "Fattori favorevoli",
    "latest_news_label": "Ultime notizie",
    "core_conclusion_heading": "Conclusione principale",
    "one_sentence_label": "Decisione in breve",
    "time_sensitivity_label": "Orizzonte temporale",
    "default_time_sensitivity": "Entro questa settimana",
    "position_status_label": "Stato della posizione",
    "action_advice_label": "Azione suggerita",
    "no_position_label": "Titolo non in portafoglio",
    "has_position_label": "Titolo in portafoglio",
    "continue_holding": "Continua a mantenere",
    "market_snapshot_heading": "Situazione di mercato",
    "close_label": "Chiusura",
    "prev_close_label": "Chiusura precedente",
    "open_label": "Apertura",
    "high_label": "Massimo",
    "low_label": "Minimo",
    "change_pct_label": "Variazione %",
    "change_amount_label": "Variazione",
    "amplitude_label": "Ampiezza delle oscillazioni",
    "volume_label": "Volume",
    "amount_label": "Controvalore scambiato",
    "current_price_label": "Prezzo attuale",
    "volume_ratio_label": "Rapporto dei volumi",
    "turnover_rate_label": "Tasso di rotazione",
    "source_label": "Fonte",
    "data_sources_label": "Fonti dei dati",
    "data_perspective_heading": "Analisi dei dati",
    "ma_alignment_label": "Allineamento delle medie mobili",
    "bullish_alignment_label": "Allineamento rialzista",
    "yes_label": "Sì",
    "no_label": "No",
    "none_label": "Nessuno",
    "trend_strength_label": "Forza della tendenza",
    "price_metrics_label": "Indicatori di prezzo",
    "bias_ma5_label": "Scostamento dalla MA5",
    "support_level_label": "Supporto",
    "resistance_level_label": "Resistenza",
    "chip_label": "Distribuzione dei prezzi di carico",
    "phase_decision_heading": "Vincoli operativi della fase di mercato",
    "action_window_label": "Finestra operativa",
    "immediate_action_label": "Azione attuale",
    "watch_conditions_label": "Condizioni da monitorare",
    "next_check_time_label": "Prossimo controllo",
    "confidence_reason_label": "Motivo del livello di fiducia",
    "data_limitations_label": "Limiti dei dati",
    "battle_plan_heading": "Piano operativo",
    "ideal_buy_label": "Ingresso ideale",
    "secondary_buy_label": "Ingresso alternativo",
    "stop_loss_label": "Stop loss",
    "take_profit_label": "Obiettivo di profitto",
    "suggested_position_label": "Dimensione della posizione",
    "entry_plan_label": "Strategia di ingresso",
    "risk_control_label": "Gestione del rischio",
    "checklist_heading": "Lista di controllo",
    "failed_checks_heading": "Controlli non superati",
    "history_compare_heading": "Confronto con i segnali precedenti",
    "time_label": "Data e ora",
    "score_label": "Punteggio",
    "advice_label": "Indicazione",
    "trend_label": "Tendenza",
    "generated_at_label": "Report generato il",
    "report_time_label": "Generato il",
    ...
    "position_advice_heading": "Indicazioni sulla posizione",
    "analysis_model_label": "Modello",
    "not_investment_advice": "Contenuto generato dall'AI a scopo informativo. Non costituisce consulenza finanziaria.",
    "details_report_hint": "Vedi il report dettagliato:",
    "financial_summary_heading": "Riepilogo finanziario",
    "report_date_label": "Data del report",
    "revenue_label": "Ricavi",
    "net_profit_label": "Utile netto attribuibile alla controllante",
    "operating_cash_flow_label": "Flusso di cassa operativo",
    "revenue_yoy_label": "Variazione annua dei ricavi",
    "net_profit_yoy_label": "Variazione annua dell'utile netto",
    "gross_margin_label": "Margine lordo",
    "shareholder_return_heading": "Remunerazione degli azionisti",
    "ttm_cash_dividend_label": "Dividendo lordo per azione negli ultimi 12 mesi",
    "ttm_event_count_label": "Numero di dividendi negli ultimi 12 mesi",
    "ttm_dividend_yield_label": "Rendimento da dividendi negli ultimi 12 mesi",
    "latest_ex_dividend_label": "Ultima data di stacco",
    "institutional_flow_heading": "Flussi delle tre categorie istituzionali",
    "institutional_flow_note": "Positivo = acquisti netti; negativo = vendite nette. Unità: azioni.",
    "inst_foreign_label": "Investitori esteri",
    "inst_trust_label": "Fondi di investimento",
    "inst_dealer_label": "Intermediari",
    "inst_total_label": "Totale delle tre categorie",
    "related_boards_heading": "Settori e temi collegati",
    "industry_boards_heading": "Settori industriali",
    "concept_boards_heading": "Temi di investimento",
    "board_name_label": "Settore o tema",
    "board_type_label": "Tipo",
    "board_status_label": "Andamento",
    "board_change_pct_label": "Variazione %",
    "leading_board_label": "In testa ai rialzi",
    "lagging_board_label": "In testa ai ribassi",
    "signal_attribution_heading": "Origine dei segnali",
    "attribution_weights_label": "Peso dei fattori",
    ...
    "strategy_conflict_label": "Disaccordo",
    "strategy_confidence_label": "Livello di fiducia",
    "strategy_summary_label": "Riepilogo",
    "strategy_supporting_skills_label": "Strategie favorevoli",
    "strategy_opposing_skills_label": "Strategie contrarie",
    "strategy_invalid_opinions_label": "{count} altre strategie non hanno prodotto segnali validi",
})
